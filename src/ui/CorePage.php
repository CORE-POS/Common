...
class CorePage 
{
    ...
    */
    ...
    public function baseTest($phpunit)
    {
        ...
        if (file_exists(__DIR__ . '/../../fannie/config.php')) {
        ...
        } elseif (class_exists('MockSQL', false)) {
        ...
        $phpunit->assertEquals(false, $this->tableHasColumnReadinessCheck($FANNIE_OP_DB, 'products', 'upc'));
    }
}
